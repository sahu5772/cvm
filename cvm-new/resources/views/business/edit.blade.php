...
<main class="addEmployee_wrapper">
    <div class="container">
        ...
        <div class="form_wrapper">
            <form action="{{ route('business.update', $businessUnit->id) }}" method="POST">
                @method('patch')
                @csrf
                <div class="row">
                    <div class="col-sm-4">
                        <div class="input_grp">
                            ...
                            <input type="text" name="name" value="{{ $businessUnit->name }}" placeholder="Enter name" />
                            @error('name')
                    ...
                    <div class="col-sm-4">
                        <div class="input_grp">
                            ...
                            <input type="number" name="phone_number" value="{{ $businessUnit->phone_number }}" placeholder="type here..." />
                            @error('phone_number')
                                <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="input_grp">
                            ...
                            <input type="text" name="address" value="{{ $businessUnit->address }}" placeholder="type here..." />
                            @error('address')
                                <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="input_grp">
                            ...
                            <select name="country_id" class="country">
                                ...
                                @foreach ($countries as $country)
                                    <option value="{{ $country->id }}" {{ ($businessUnit->country_id == $country->id) ? 'selected' : '' }}>{{ ucfirst($country->name)}}</option>
                                @endforeach
                            </select>
                            @error('country_id')
                                <span style="color: red">{{ $message }}</span>
                        ...
                        <div class="input_grp">
                            ...
                            <select name="state_id" class="state">
                                ...
                                @foreach ($states as $state)
                                    <option value="{{ $state->id }}" {{ ($businessUnit->country_id == $state->id) ? 'selected' : '' }}>{{ ucfirst($state->name)}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="input_grp">
                            ...
                            <select name="city_id" class="city">
                                ...
                                @foreach ($cities as $city)
                                    <option value="{{ $city->id }}" {{ ($businessUnit->country_id == $city->id) ? 'selected' : '' }}>{{ ucfirst($city->name)}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-sm-4">
                        <div class="input_grp">
                            ...
                            <input type="number" name="pin_code" value="{{ $businessUnit->pin_code }}" placeholder="type here..." />
                            @error('pin_code')
                                <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="input_grp">
                            ...
                            <select name="timezone_id">
                                ...
                                @foreach ($timezones as $timezone)
                                    <option value="{{ $timezone->id }}" {{ ($businessUnit->id == $timezone->id) ? 'selected' : ''}} >{{ ucfirst($timezone->timezone)}}</option>
                                @endforeach
                            </select>
                            @error('timezone_id')
                                <span style="color: red">{{ $message }}</span>
