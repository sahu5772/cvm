...
<main class="master__wrapper">
    ...
    <section class="inner__wrapper">
      ...
      <div class="col-4">
        <div id="category">
        <x-form action="{{ route('pavement.store') }}" method="post">
      ...
      <div class="col-8">
          ...
          <table class="table pavement_datatable">
              <thead>
              <tr>
...
<script>
  $(function () {
    ...
    var table = $('.pavement_datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('pavement.index') }}",
        columns: [
  ...
  function deletePavement(e) {
    var url = '{{ route("pavement.destroy", ":id") }}';
          ...
          if (result.value) {
              $.ajax({
                  ...
                  success: function(data) {
                        if (data.success) {
                        $('.pavement_datatable').DataTable().ajax.reload();
